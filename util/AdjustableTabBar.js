...
//TODO: Should the below items be referencing node_modules directly?
import TouchableItem from '../node_modules/react-native-tab-view/src/TouchableItem';
import { SceneRendererPropType } from '../node_modules/react-native-tab-view/src/TabViewPropTypes';
import type {
  Scene,
  SceneRendererProps,
  Style,
} from '../node_modules/react-native-tab-view/src/TabViewTypeDefinitions';
...
export default class AdjustableTabBar<T: *> extends React.Component<Props<T>, State> {
  static propTypes = {
  ...
  constructor(props: Props<T>) {
    ...
    this.adjustWidth = this.props.adjustWidth || 1.0;
  ...
  _handlePosition = () => {
    ...
    const panX = typeof this._lastPanX === 'number' ? this._lastPanX * this.adjustWidth : 0;
    const offsetX =
      typeof this._lastOffsetX === 'number'
        ? this._lastOffsetX * this.adjustWidth
  ...
  _getScrollAmount = (props, i) => {
    ...
    const adjustedIndex = i * this.adjustWidth;
    ...
    //     lW: layout.width,
    //     sA: scrollAmount,
    //     nSA: scrollAmount * this.adjustWidth
    // }
